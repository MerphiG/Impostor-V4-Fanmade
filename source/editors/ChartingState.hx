...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['For Cleaning Song', "Value 1: Alpha \nValue 2: Time"],
		['HP, Time and Info', "Value 1: Alpha \nValue 2: Time"],
		['Notes Alpha', "Value 1: Alpha \nValue 1: Time"],
		['Blackout Fire On', "Value 1: Time"],
		['Blackout Fire Off', "Value 1: Time"],
		['Blackout Fire Appears', "Value 1: Alpha \nValue 1: Time"]
	];
